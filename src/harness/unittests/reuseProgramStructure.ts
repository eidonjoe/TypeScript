...
/// <reference types="typerefs1" />`;
        ...
        it("resolution cache follows imports", () => {
            ...
            checkResolvedModulesCache(program_1, "a.ts", createMapFromMapLike({ "b": { resolvedFileName: "b.ts" } }));
            ...
            checkResolvedModulesCache(program_4, "a.ts", createMapFromMapLike({ "b": { resolvedFileName: "b.ts" }, "c": undefined }));
        });
        ...
        it("resolved type directives cache follows type directives", () => {
            ...
            const program_1 = newProgram(files, ["/a.ts"], options);
            checkResolvedTypeDirectivesCache(program_1, "/a.ts", createMapFromMapLike({ "typedefs": { resolvedFileName: "/types/typedefs/index.d.ts", primary: true } }));
